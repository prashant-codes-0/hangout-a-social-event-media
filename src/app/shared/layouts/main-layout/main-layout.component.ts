...
export class MainLayoutComponent {
  ...
  navigationItems = computed(() => [
    ...
    },
    {
      ...
      icon: 'search',
      route: '/hangouts',
      active: this.currentRoute().startsWith('/hangouts') && this.currentRoute() !== '/hangouts/create'
    },
    ...(this.isAuthenticated() ? [
      {
        label: 'My Hangouts',
        icon: 'user-group',
        route: '/hangouts/my-hangouts',
        active: this.currentRoute() === '/hangouts/my-hangouts'
      },
      {
        label: 'Joined',
        icon: 'calendar',
        route: '/hangouts/joined-hangouts',
        active: this.currentRoute() === '/hangouts/joined-hangouts'
      },
      {
        label: 'Create',
        icon: 'plus',
        route: '/hangouts/create',
        active: this.currentRoute() === '/hangouts/create',
        highlight: true
      }
    ] : [])
  ]);
